...
class BasicBlockKSize(nn.Module):
    expansion = 1

    def __init__(self, in_planes, planes, kernel_size, stride=1):
        super(BasicBlockKSize, self).__init__()
        self.conv1 = nn.Conv2d(
...
def ResNet_three_layer_13():
    return ResNetThreeLayer2(BasicBlockKSize, 3, [2, 2, 2])

def ResNet_three_layer_14():
    return ResNetThreeLayer2(BasicBlockKSize, 5, [2, 2, 2])
...
def ResNet_four_layer_3():
    return ResNetFourLayer2(BasicBlockKSize, 3, [2, 2, 2, 2])

def ResNet_four_layer_4():
    return ResNetFourLayer2(BasicBlockKSize, 3, [2, 2, 2, 3])

def ResNet_four_layer_5():
    return ResNetFourLayer2(BasicBlockKSize, 3, [2, 2, 3, 3])

def ResNet_four_layer_6():
    return ResNetFourLayer2(BasicBlockKSize, 3, [2, 3, 3, 3])

def ResNet_four_layer_7():
    return ResNetFourLayer2(BasicBlockKSize, 3, [3, 3, 3, 3])
